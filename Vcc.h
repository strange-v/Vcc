...
#ifndef VCC_DEFAULT_REFERENCE_CALIBRATION
#define VCC_DEFAULT_REFERENCE_CALIBRATION 1125300L
#endif

#define VCC_EEPROM_SIGNATURE 0xA6
...
#ifdef VCC_EEPROM
    bool loadCalibrationFromEEPROM(int16_t address);
